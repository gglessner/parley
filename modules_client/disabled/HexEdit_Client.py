...
module_description = "Allow hex editing of client data before sending"
...
def module_function(message_num, source_ip, source_port, dest_ip, dest_port, message_data):
    ...
    try:
        ...
        if modified_data != message_data:
            ...
            write_to_log(source_ip, source_port, dest_ip, dest_port, log_message)
            print(log_message)
        else:
